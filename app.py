...
def add_task():
    if request.method == "POST":
        ...
        mongo.db.tasks.insert_one(task) # this argument is the 'task' dictionary on line 108
...
def edit_task(task_id):
    if request.method == "POST":
        ...
        mongo.db.tasks.update({"_id": ObjectId(task_id)}, submit) # this argument is the 'submit' dictionary on line 128
